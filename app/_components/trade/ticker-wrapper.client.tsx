...
const TickerWrapper = () => {
  ...
  const estimatedFundingRate = useMemo(() => {
    return marketStats.data?.funding_rate?.estimated_funding_rate ?? 0;
  }, [marketStats.data]);
  ...
  const fundingDetailContent = (
    <div className="flex flex-col gap-3">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-primary/45 text-[11px] uppercase tracking-[0.08em]">
            Applied
          </p>
          <p
            className={cn(
        ...
        <div className="text-right">
          ...
          <p className="text-primary/72 mt-1 text-sm font-medium tabular-nums">
            {countdownString}
          </p>
        </div>
      </div>

      <div className="border-outline/70 rounded-md border bg-primary/[0.03] px-3 py-2.5">
        <p className="text-primary/45 text-[11px] uppercase tracking-[0.08em]">
          Estimated Next
        </p>
        <p
      ...
      <p className="text-primary/55 text-xs leading-relaxed">
        Estimate is provided by the exchange and reflects projected funding at
        the next checkpoint. It can change before the checkpoint is reached.
      </p>
    </div>
  );
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2 px-3 py-2 lg:hidden">
        ...
        <div className="grid grid-cols-2 gap-x-3 gap-y-2 md:gap-x-5">
          <div className="min-w-0">
            <Dialog>
              <DialogTrigger asChild>
                ...
                >
                  ...
                  <Resource
                    ...
                    placeholder={<Skeleton className="mt-1.5 h-8 w-[120px]" />}
                  >
                    <div className="mt-1.5 flex min-w-0 flex-col gap-0.5">
                      <div className="flex min-w-0 items-center gap-1 whitespace-nowrap">
                        ...
                        <span className="text-[11px] font-normal tabular-nums leading-none text-primary-accent/60">
                          {countdownString}
                        </span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="text-[10px] leading-none text-primary-accent/40">
                          Est
                        </span>
                        <span
                          className={cn(
                            ...
                            estimatedFundingRate === 0
                              ? "text-primary-accent/55"
                              : estimatedFundingRate > 0
                                ? "text-green-medium/70"
                                : "text-red/70"
                          )}
                        >
                          {estimatedFundingRateLabel}
              ...
              <DialogContent className="max-w-[calc(100vw-2rem)] md:max-w-sm">
                <DialogTitle>Funding (1h)</DialogTitle>
                <DialogDescription className="text-primary/60">
                  Current applied funding and an estimate for the next
                  checkpoint.
                </DialogDescription>
          ...
          <div className="min-w-0">
            ...
            >
              <span className="mt-1 inline-block whitespace-nowrap text-[13px] font-medium tabular-nums leading-none text-primary">
                {oiShowBtc
        ...
        <div className="border-outline/60 grid grid-cols-3 gap-x-2.5 gap-y-2 border-t pt-2 md:gap-x-4">
          <div className="min-w-0">
            ...
            >
              <span className="mt-1 inline-block whitespace-nowrap text-[12px] font-medium tabular-nums leading-none text-primary">
                {formatCurrency(high)}
              </span>
            </Resource>
          </div>
          ...
          <div className="min-w-0">
            ...
            >
              <span
                className={cn(
                  "mt-1 inline-block whitespace-nowrap text-[12px] font-medium tabular-nums leading-none",
          ...
          <div className="min-w-0">
            ...
            >
              <div className="mt-1 flex min-w-0 flex-col gap-1">
                ...
                <div className="flex items-baseline gap-0.5 text-[10px] font-medium tabular-nums leading-none">
                  <span className="text-green-medium">
                    {longPercent.toFixed(0)}
                  </span>
                  <span className="text-primary-accent/75">L</span>
      ...
      {/* Desktop ticker */}
      <div className="hidden items-stretch overflow-x-auto px-1 py-2.5 [-ms-overflow-style:none] [scrollbar-width:none] lg:flex xl:px-3 xl:py-3 2xl:px-4 3xl:px-5 [&::-webkit-scrollbar]:hidden">
        {/* bitcoin ticker */}
        <div className="flex shrink-0 items-center">
          <div className="flex min-w-0 items-center gap-1.5 pr-1 xl:gap-2 xl:pr-3 2xl:pr-4 3xl:pr-4">
            <Image
              width={24}
              height={24}
            ...
            <div className="min-w-0 max-w-[68px] xl:max-w-[104px] 2xl:max-w-[116px] 3xl:max-w-[128px]">
              <p className="text-primary/96 truncate text-[15px] font-semibold leading-tight xl:text-[16px] 3xl:text-[17px]">
                Bitcoin
              </p>
        ...
        <div className="flex shrink-0 items-center">
          {finalPrice === 0 ? (
            ...
            <div className="w-[160px] px-1 xl:w-[208px] xl:px-3 2xl:w-[228px] 2xl:px-4 3xl:w-[244px] 3xl:px-4">
              <div className="text-primary/44 mb-1 flex items-center gap-1 text-[9px] font-medium uppercase tracking-[0.04em] xl:text-[10px] xl:tracking-[0.06em] 3xl:text-[11px]">
                <span className="relative inline-flex h-[5px] w-[5px] shrink-0">
                  <span className="absolute inset-0 animate-pulse rounded-full bg-green-medium/25" />
                  <span className="bg-green-medium/65 relative h-[5px] w-[5px] rounded-full" />
                </span>
              ...
              <p
                className={cn(
                  ...
                  "whitespace-nowrap text-left text-[1.4rem] font-semibold tabular-nums leading-none tracking-tight transition-colors xl:text-[1.95rem] 2xl:text-[2.125rem] 3xl:text-[2.25rem]"
                )}
              >
                {currentPrice
                  ? formatCurrency(currentPrice)
        ...
        <TickerItem
          className="w-[80px] xl:w-[96px] 2xl:w-[112px] 3xl:w-[116px]"
          itemClassName="shrink-0"
          title="24H High"
        >
          <Resource
        ...
        <TickerItem
          className="w-[60px] xl:w-[76px] 2xl:w-[104px] 3xl:w-[108px]"
          itemClassName="shrink-0"
          title="24H Turnover"
        >
          <Resource
        ...
        >
          ...
          >
            <span
              ...
              title={
                oiShowBtc
                  ? "Show open interest in USD"
                  : "Show open interest in BTC"
              }
            >
              <span
                className={cn(
        ...
        <TickerItem itemClassName="shrink-0 pl-1" title="OI Skew">
          <Resource
            isLoaded={hasMarketStats}
            placeholder={
              <Skeleton className="h-6 w-[60px] xl:w-[88px] 2xl:w-[108px] 3xl:w-[116px]" />
            }
          >
            <div className="flex min-w-[60px] flex-col gap-0.5 xl:min-w-[88px] 2xl:min-w-[116px] 3xl:min-w-[124px]">
              <div className="relative flex h-[5px] w-[60px] overflow-hidden rounded-[1px] xl:w-[88px] 2xl:w-[116px] 3xl:w-[124px]">
                <div
                  className="bg-green-medium"
                  style={{ width: `${longPercent}%` }}
                />
              ...
              <div className="flex justify-between text-[9px] tabular-nums leading-none xl:text-[10px] 3xl:text-[11px]">
                <span className="flex items-baseline gap-0.5">
                  <span className="text-green-medium/90">
                    {longPercent.toFixed(0)}%
                  </span>
        ...
        <TickerItem
          className="w-[108px] xl:w-[120px] 2xl:w-[148px] 3xl:w-[156px]"
        ...
        <TickerItem
          className="w-[148px] overflow-hidden xl:w-[158px] 2xl:w-[186px] 3xl:w-[196px]"
          itemClassName="shrink-0 pl-1"
          border={false}
          title="Funding (1h)"
        >
          <Resource
            isLoaded={hasFundingData}
            placeholder={<Skeleton className="h-9 w-full" />}
          >
            <Popover>
              <PopoverTrigger asChild>
                <button
                  type="button"
                  className="flex w-full flex-col items-start gap-0.5 overflow-hidden whitespace-nowrap rounded px-1 py-0.5 text-left transition-colors hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary/40"
                ...
                >
                  <div className="flex items-center gap-1">
                    <span
                      className={cn(
                        "text-[13px] font-semibold tabular-nums leading-none xl:text-[14px] 2xl:text-[15px] 3xl:text-[15px]",
                        !fundingRate || parseFloat(fundingRate) === 0
                          ? "text-primary"
                          : parseFloat(fundingRate) > 0
                            ? "text-green-medium"
                    ...
                    <span className="text-[9px] font-normal tabular-nums leading-none text-primary/60 xl:text-[11px] 2xl:text-[12px] 3xl:text-[12px]">
                      {countdownString}
                    </span>
                    <ExternalLink className="text-primary/35 h-3 w-3" />
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="text-[9px] leading-none text-primary/40 xl:text-[10px]">
                      Est
                    </span>
                    <span
                      className={cn(
                        "text-[9px] font-medium tabular-nums leading-none xl:text-[10px]",
                        estimatedFundingRate === 0
                          ? "text-primary/55"
                          : estimatedFundingRate > 0
                            ? "text-green-medium/70"
